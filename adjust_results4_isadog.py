...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dictionary:
            ...
            # Classifier Label IS image of Dog appends (1, 1) because both labels are dogs
            if results_dic[key][1] in dognames_dictionary:
                results_dic[key].extend((1, 1))

            # Classifier Label IS NOT image of dog appends (1,0) because only pet label is a dog
            else:
